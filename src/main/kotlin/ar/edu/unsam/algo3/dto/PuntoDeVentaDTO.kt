...
data class PuntosDeVentaDTOUserless(val id: Int, val nombre: String, val tipo: String,val stockDeSobres: Int, val direccion: String , val pedidosPendientes:Pedido)

fun PuntoDeVentas.toDTOUserless() = PuntosDeVentaDTOUserless(id = id, nombre = nombre, tipo = tipo(), stockDeSobres=stockDeSobres, direccion= direccion(), pedidosPendientes=pedidosPendientes)
